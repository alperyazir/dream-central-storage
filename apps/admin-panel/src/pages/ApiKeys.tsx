...
const ApiKeysPage = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage API keys for external service authentication (e.g. LMS
            integration).
          </p>
        </div>
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new key for external service authentication.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog
        open={!!revokeTarget}
        onOpenChange={() => !revoking && setRevokeTarget(null)}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Revoke API Key?</DialogTitle>
            <DialogDescription>
              Revoke &quot;{revokeTarget?.name}&quot;? Any services using this
